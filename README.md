...
![The server terminal showing it is bound to the port and receiving messages from the client](screenshots/server1.png)

### Client Sending Data
![The client terminal showing the connection established and the user sending a message](screenshots/client1.png)
